...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \Illuminate\View\Middleware\ShareFromSession::class,
    ...
    protected $routeMiddleware = [
        ...
        'visibility' => \App\Http\Middleware\setVisibility::class,
        'patientQuestion' => \App\Http\Middleware\patientQuestion::class,
        'reportPermission' => \App\Http\Middleware\reportPermission::class,
        'userExists' => \App\Http\Middleware\userExists::class,
        'hasPrevilege' => \App\Http\Middleware\hasPrevilege::class,
    ];
}

...
Route::group(array('module' => 'Patient', 'prefix' => 'patient', 'middleware' => ['web', 'patient', 'valid.session'], 'namespace' => 'App\Modules\Patient\Controllers'), function() {
    Route::get('/', 'QuestionController@questions');
    ...
    Route::get('/medicalRecords', 'PatientController@medicalRecords');
    Route::get('/notifications', 'PatientController@notifications');

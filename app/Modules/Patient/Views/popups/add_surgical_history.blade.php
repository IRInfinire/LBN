...
<div class="modal-body">
   ...
   <div class="col-sm-12 mrgn-btm-20">
      ...
      <div class="input-group datepicker-control mrgn-tp-15 form_date date" data-date="" data-date-format="mm/dd/yyyy">
         {!! Form::text('surgery_date', isset($surgicalHistoryData->surgery_date) ? Carbon\Carbon::parse($surgicalHistoryData->surgery_date)->format('m/d/Y') : old('surgery_date'), ['id' => 'surgery_date', 'class' => 'form-control','readonly' => 'true', 'placeholder' => 'Select Date.','size' => '50x5','maxlength' => '1000', 'onclick' => 'this.blur();']) !!}

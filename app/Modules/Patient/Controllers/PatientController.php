                        ...
                        ->edit_column('name', function($notications) use ($requestData, $notificationsRepo) {
                            if ($requestData['listType'] == 'Notifications') {
                                if ($notications->is_seen)
                                    ...
                                    $return = '<div id="divPanel' . $notications->id . '" class="content-sub noti-box noti-unread mrgn-btm-20"><a href="' . url('patient/questions/' . $notications->question_recipients_id . '/brief') . '">';

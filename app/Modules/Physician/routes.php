...
Route::group(array('module' => 'Physician', 'prefix' => 'physician', 'middleware' => ['web','auth', 'valid.session'], 'namespace' => 'App\Modules\Physician\Controllers'), function() {
    ...
    Route::group(['middleware' => 'subscribed'], function () {
        Route::get('/createQuestionSet', 'QuestionSetController@createQuestionSet')->middleware('access:questionset_create');
    ...
    Route::get('/questionSet', 'PhysicianController@questionSet')->middleware('access:questionset_list');
    Route::get('/questionSetPreview/{id}', 'PhysicianController@questionSetPreview')->middleware('access:questionset_list')->where('id', '[0-9]+');
    Route::get('/questionSetPreview/{id}/*', 'PhysicianController@questionSetPreview')->middleware('access:questionset_list')->where('id', '[0-9]+');
    Route::get('/questionSetPreview/{id}/edit', 'PhysicianController@questionSetPreview')->middleware('access:questionset_list')->where('id', '[0-9]+');
    ...
    Route::get('/question-set-detail/{id}', 'QuestionSetController@questionSetDetail')->where('id', '[0-9]+');
    ...
    Route::get('/viewMedicalRecord/{id}', 'PhysicianController@viewMedicalRecord')->where('id', '[0-9]+');
    ...
    Route::get('/listNotifications', 'PhysicianController@listNotifications');
    Route::get('/notifications', 'PhysicianController@getNotificationsList');
    ...
    Route::get('/profile', 'PhysicianController@profile');
    ...
    ])->middleware('access:patient_list');

...
<div class="content-wrapper">
    ...
    <!-- Main content -->
    {!! Form::open(['route' => 'physician.adminstaff.update','id'=>'adminEditFrm','name'=>'adminEditFrm']) !!}  
        {!! csrf_field() !!}
                    ...
                    <div class="col-sm-12">
                        <div class="row mrgn-btm-15">
                            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-5">                                
                                {!! Form::text('name', $adminStaff['name'], ['class' => 'form-control','placeholder'=>"Full Name",'autofocus'=>"",'id' => "name"]) !!}                               
                            </div>
                        </div>

                        <div class="row mrgn-btm-15">
                            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-5">
                                {!! Form::text('email', $adminStaff['email'], ['class' => 'form-control','placeholder'=>"Email Address",'id' => "email"]) !!}
                            </div>

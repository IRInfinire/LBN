...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <div id="collapseOne" aria-expanded="false" class="collapse" style="">
         {!! Form::open(['role' => 'form', 'name' => 'frmQuestionSet', 'url'=>'physician/postQuestionSet', 'id' => 'frmQuestionSet','autocomplete' => 'off']) !!}
         ...
         <div class="content-sub mrgn-btm-15 pdng-0">
            ...
            <div class="content-area-sub">
               ...
               <div class="col-sm-12 mrgn-btm-15">
                  <div class="checkbox">
                     <input id="category{{$category->id}}" name="category{{$category->id}}" type="checkbox" value="{{$category->id}}" @if($category->id == 10) {{'class=other-catgy'}}@endif>
                  ...
                  <div class="col-sm-12 col-lg-6 mrgn-lft-15 mrgn-tp-20  hidden div_other_question" >
                     <input type='text' class="form-control " id="other_question" name="other_question" maxlength="255" placeholder="{{trans('custom.other_question')}}" value="{{trans('custom.other_question')}}">
                  </div>
                  @endif
               </div>
               @endforeach
               ...
               <input type="hidden" id="categoryCount" name="categoryCount" value="{{count($categories)}}" >
            </div>
         </div>
         {!! Form::close() !!}
      </div>
      ...
      <div class="btn-wrap hidden" id="div-submit-next-on-create-question">
         <!--<button type="button" class="btn btn-primary mrgn-lft-15" onclick="location.href ='{{url('physician/createQuestionSetNext')}}'">Next</button>-->
         ...
         <button type="button" class="btn btn-default" style="display: none"  onclick="location.href = '{{url('physician/home')}}'" title="Cancel" id="btn-create-question-cancel">Cancel</button>
      </div>
   </section>
   <!-- /.content -->
</div>

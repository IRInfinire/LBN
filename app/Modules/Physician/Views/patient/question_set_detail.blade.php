...
<div class="content-wrapper">
   ...
   <section class="content content-library">
      ...
      {!! Form::open(['route' => ['physician.question.answers',$questionSet->id],'id'=>'physicianAnswerFrm','name'=>'physicianAnswerFrm']) !!}
      ...
      <div class="btn-wrap">  
          ...
          @endif
          <a href="{!! route('physician.patient.details',$questionSet->patient->id) !!}"><button type="button" class="btn btn-default mrgn-lft-15" onclick="location.href = '{!! route('physician.patient.details',$questionSet->patient->id) !!}'">Cancel</button></a>

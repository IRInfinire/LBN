   ...
   <div class="content-area-sub" >
      ...
      <div class="col-sm-12" id="div-header">
         ...
         <div class="row mrgn-btm-25">
            ...
            <div class="col-sm-4"><input class="form-control" id="txtNarrativeOutput3" name="txtNarrativeOutput3" value="@if(count($narrativeOutput)>1){{$narrativeOutput[1]}}@endif" ></div>
         </div>
      </div>

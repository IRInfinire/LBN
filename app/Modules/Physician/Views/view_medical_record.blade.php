...
<div class="clearfix"></div>
   ...
   <!--         <table class="table">
            ...
            <div class="content-area-sub">
                <div class="col-sm-12">
                    <div class="row mrgn-btm-15">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"><p>Do you smoke?</p></div><div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">@if(count($socialHistory)>0 ) {{setYesOrNo($socialHistory->smoke)}} @else{{'-'}} @endif</div>
                    </div>

                    <div class="row mrgn-btm-15">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"><p>Do you drink alcohol?</p></div><div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">@if(count($socialHistory)>0) {{setYesOrNo($socialHistory->drink)}} @else{{'-'}} @endif</div>
                    </div>

                    <div class="row mrgn-btm-15">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"><p>Do you take drugs?</p></div><div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">@if(count($socialHistory)>0) {{setYesOrNo($socialHistory->drug)}} @else{{'-'}} @endif</div>
                    </div>
        ...
        <div class="content-sub mrgn-btm-20 pdng-0">
            ...
            <div class="content-area-sub">
                <div class="col-sm-12">
                    @if(count($socialHistory)>0) {{$socialHistory->comments}}  @endif
                </div>
            </div>
        </div>

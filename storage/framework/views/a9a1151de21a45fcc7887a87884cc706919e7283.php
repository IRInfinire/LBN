      ...
      <div class="content-sub mrgn-btm-20 pdng-0">
         <div class="content-sub-heading">
            <div class="col-sm-12">
               ...
               <?php if(hasPermission('patient_summaryReportList')): ?> 
               <a href="<?php echo e(route('physician.summary.pdf', $qRecId)); ?>" target="_blank" class="edit pull-right txt-blue" type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Print">
                  ...
                  <li class="dropdown email-option">
                     ...
                     <div class="dropdown-menu summary-email">
                        ...
                        <form class="form" id="formLogin">
                           ...
                           <div class="button-wrap"> <button type="button" onclick="sendSummaryReport(<?php echo e($summaryDet['patient_id']); ?>, <?php echo e($summaryDet['question_id']); ?>, <?php echo e(Request::segment(3)); ?>, 'S')" id="btnSendReport" class="btn btn-primary mrgn-tp-20">Send</button>
                           </div>
         ...
         <div class="content-area-sub">
            <?php echo $__env->make('Physician::patient.partials._narrative_output', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
         </div>
      </div>
      <section class="content-sub-header">
         <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1 pull-right">
            <div class="row">
               <a href="<?php echo route('physician.patient.details',$summaryDet['patient']['id']); ?>"><button type="button" class="btn btn-third btn-block  mrgn-btm-15">Back</button></a>
            </div>
         </div>
      </section>
   </section>

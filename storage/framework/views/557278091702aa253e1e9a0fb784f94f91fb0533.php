...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <h1>Make Question Set link of the <?php echo e($questionSets->title); ?> to:</h1>
   </section>
   ...
   <section class="content">
               ...
               <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog modal-lg" role="document">
                     <div class="modal-content">
                        ...
                        <?php echo Form::open(['url' => 'physician/sendQuestionSet','class' => '', 'id' => 'postSendQuestionSetPopup','name' => 'postSendQuestionSetPopup', 'method' => 'post']); ?>
                        ...
                        <div class="modal-body  min-height-504">
                           ...
                           <div class="table-responsive" >
                              <?php echo e(Form::hidden('question_id', $question_id)); ?>

                              <?php echo e(Form::hidden('selectType', 'list')); ?>
                           ...
                           <?php echo e(Form::hidden('totalRows', '0', array('id' => 'totalRows'))); ?>

                           <?php echo e(Form::hidden('validatePatient', '', array('id' => 'validatePatient'))); ?>
      ...
      <div class="clearfix"></div>
      <?php echo Form::open(['url' => 'physician/postSendQuestionSet','class' => 'bootstrap-modal-form', 'id' => 'postSendQuestionSet', 'method' => 'post']); ?>

      <div class="content-sub mrgn-btm-20">
         <?php echo e(Form::hidden('question_id', $question_id)); ?>

         <?php echo e(Form::hidden('selectType', 'single')); ?>
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
               <div  class="pdng-10-15">
                  ...
                  <div class="col-md-3 country-code input-group">
                     ...
                     <?php echo Form::text('country_code', '', ['class' => 'form-control send-as-text send-qs mrgn-btm-25','placeholder' => 'Code','maxlength'=>5,'disabled'=>"",'id'=>"country_code"]); ?>

                  </div>
                  <div class="col-md-9 custom_error">
                     <?php echo Form::text('phone', '', ['class' => 'form-control autoComplete send-as-text send-qs mrgn-btm-25','placeholder' => 'Contact Number','maxlength'=>15,'disabled'=>"",'id'=>'phone']); ?>

                  </div>                  
                  <!-- <span class="num_format"><?php echo e(trans('custom.phone_num_format_text')); ?></span> -->
               </div>
            </div>
         </div>
         <?php endif; ?>
...
<script type="text/javascript">
                      ...
                      parameters['ajaxUrl'] = "<?php echo route('physician.patient.popupList'); ?>";

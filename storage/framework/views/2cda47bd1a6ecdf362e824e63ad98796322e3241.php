...
<div class="col-sm-12 mrgn-btm-5 mrgn-tp-5">
   <div class="col-sm-2 col-md-2 pdng-lft-0 ">
      <!--onchange="getNextQuestionToAsk('Yes', this.value,<?php echo e($rid); ?>,<?php echo e($qid); ?>,<?php echo e($cid); ?>)"-->
...
<div class="col-sm-12 mrgn-btm-5 mrgn-tp-5">
   <div class="col-sm-2 col-md-2 pdng-lft-0 ">
      <!--onchange="getNextQuestionToAsk('No', this.value,<?php echo e($rid); ?>,<?php echo e($qid); ?>,<?php echo e($cid); ?>)"-->

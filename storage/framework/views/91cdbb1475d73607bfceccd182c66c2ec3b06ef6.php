    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 cntnt-abt">
                ...
                <button type="button" class="btn btn-default read-more mrgn-tp-20"  onclick="location.href = '<?php echo e(url('/about/')); ?>'">Learn More <i class="fa fa-angle-right" aria-hidden="true"></i></button>

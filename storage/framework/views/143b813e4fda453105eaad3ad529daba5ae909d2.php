                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="<?php echo e($style['email-body']); ?>" width="100%">
                                <table style="<?php echo e($style['email-body_inner']); ?>" align="left" width="570" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                            ...
                                            <p style="<?php echo e($style['paragraph']); ?>">
                                                Name : <?php echo e(ucwords($user->name)); ?>

                                                <br>
                                                Message : <?php echo e($user->message); ?>
...
<!--                                            <p style="<?php echo e($style['paragraph']); ?>">
                                            ...
                                            <p style="<?php echo e($style['paragraph']); ?>">
                                                Best Regards,<br>
                                                <b><?php echo e(ucwords($user->name)); ?></b>
                                            </p>
                                        </td>
                                    </tr>
                                </table>

...
<html>
    ...
    $style = [
        ...
        'paragraph-sub' => 'margin-top: 0; color: #74787E; font-size: 10px; line-height: 1.5em;',
                                    ...
                                    <tr>
                                        <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                            ...
                                            <p style="<?php echo e($style['paragraph']); ?>">
                                                Dr. <?php echo e($user->physician_name); ?> has sent the <?php if($user->report_type =='E'): ?> <?php echo e('Full Evaluation'); ?><?php else: ?> <?php echo e('Summary'); ?><?php endif; ?> Report of <?php echo e($user->patient_name); ?>. Please refer to the attached PDF file for details.
                                            </p>
...
<!--                                            <p style="<?php echo e($style['paragraph']); ?>">
                                            ...
                                            <p style="<?php echo e($style['paragraph']); ?>">
                                                Best Regards,<br>
                                                <b><?php echo e(config('app.name')); ?> Support Team</b>
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-footer_cell']); ?>">
                                            <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                This is an automatic mail; please do not reply to this email address.
                                            </p>
                                        </td>
                                    </tr>
                                </table>

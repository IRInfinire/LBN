...
<div class="content-wrapper">
   ...
   <section class="content" <?php if($questionSets->bg_image): ?> style="background-image: url(<?php echo e(asset('uploads/question_set/' . $questionSets->bg_image)); ?>)" <?php endif; ?>>
         ...
         <h4 class="pull-left">
            ...
            Questions <span class="txt-blue"><?php echo e(count($questionCategories)); ?></span></h4>
      </section>
      ...
      <?php $i = 0 ?>
      <?php $__currentLoopData = $questionCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?> <?php
      $i++;
      ...
      <div class="content-sub mrgn-btm-20 pdng-0" id="view-question-settings-<?php echo e($row->id); ?>">
         ...
         <div class="content-area-sub">
            <div class="col-sm-12 mrgn-btm-25">
               ...
               <?php echo $__env->make('layouts.answer_options', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

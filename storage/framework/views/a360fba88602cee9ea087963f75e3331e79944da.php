         ...
         <div class="tab-content mrgn-tp-25">
               ...
               <div class="content-sub mrgn-btm-20 pdng-0">
                  ...
                  <div class="content-area-sub">
                     ...
                     <div class="col-sm-8 col-md-9 col-lg-10 q-list">
                        ...
                        <p class="mrgn-tp-5">Questions: <b><?php if($questionSets): ?><?php echo e(count($questionCategories)); ?><?php endif; ?></b></p>
                    ...
                    <!-- <label class="sponsored mrgn-btm-25"><i class="fa fa-star" aria-hidden="true"></i> Sponsored</label>-->
                        ...
                        <button type="button" class="btn btn-third btn-block"  onclick="location.href ='<?php echo e(url('physician/questionSetPreview/'.$qid.'/edit')); ?>'">View Question Set</button>
                        <?php endif; ?>
                     </div>
                  </div>
               </div>
            ...
            <div role="tabpanel" class="tab-pane <?php if(collect(request()->segments())->last() == 'edit'): ?> <?php echo e('active'); ?> <?php endif; ?>" id="design">
               ...
               <section class="content-sub-header">
                  ...
                  <h4 class="pull-left">Questions <span class="txt-blue"><?php echo e(count($selectedCategories)); ?></span></h4>
                  ...
                  <div class="col-xs-12 col-sm-5 col-md-4 col-lg-2 pull-right">
                     <div class="row">
                        ...
                        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                           <?php echo $__env->make('layouts.add_question_category', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

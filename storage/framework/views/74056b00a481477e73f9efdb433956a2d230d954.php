   ...
   <div class="content-area-sub" >
      ...
      <div class="col-sm-12" id="div-header">
         ...
         <div class="row mrgn-btm-25">
            ...
            <div class="col-sm-4"><input class="form-control" id="txtNarrativeOutput3" name="txtNarrativeOutput3" value="<?php if(count($narrativeOutput)>1): ?><?php echo e($narrativeOutput[1]); ?><?php endif; ?>" ></div>
         </div>
      </div>

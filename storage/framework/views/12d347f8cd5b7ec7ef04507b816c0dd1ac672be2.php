    <?php $__empty_1 = true; $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); $__empty_1 = false; ?> 
        ...
        <div class="col-sm-12 mrgn-btm-20">            
                <ul class="parent">   
                    ...
                    <li>  
                        <?php $__empty_2 = true; $__currentLoopData = $menu['permissions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); $__empty_2 = false; ?> 
